...
/*
	if (flag_array[dd_index] & (FLAG_INTERFACE | FLAG_FLUID))	\
...
__kernel void lbm_beta_flag_gas_to_interface(
		...
		)
{
	...
	if (flag == FLAG_GAS_TO_INTERFACE)
	{
		...
		// we leave the fluid mass and fluid fraction unchanged cz. those should be already around 1.0f
		...
		current_dds[gid] = eq_dd18(dd_param, rho);
