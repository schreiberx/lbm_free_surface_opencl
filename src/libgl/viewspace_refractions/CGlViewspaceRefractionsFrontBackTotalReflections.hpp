...
#ifndef CGL_VIEWSPACE_REFRACTIONS_FRONT_BACK_TOTAL_REFLECTIONS_HPP
#define CGL_VIEWSPACE_REFRACTIONS_FRONT_BACK_TOTAL_REFLECTIONS_HPP
 ...
 */
class CGlViewspaceRefractionsFrontBackTotalReflections	:
...
public:
	 ...
	 */
	CGlViewspaceRefractionsFrontBackTotalReflections()
	{
		/*
		 * GLSL program for refractions in viewspace
		 */
		cGlProgram.initVertFragShadersFromDirectory("viewspace_refractions/front_back_total_reflections");
