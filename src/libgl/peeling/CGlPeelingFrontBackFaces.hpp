...
/*
 * CGlDepthPeelingFrontBackFaces.hpp
 *
 *  Created on: Mar 20, 2010
 *      Author: martin
 */

#ifndef CGL_PEELING_FRONT_BACK_FACES_HPP_
#define CGL_PEELING_FRONT_BACK_FACES_HPP_
...
/**
 * extract front and back faces of mesh
 */
class CGlPeelingFrontBackFaces
{
...
public:
	...
	CGlPeelingFrontBackFaces(
				...
				GLsizei p_height	///< height of viewport/textures
					...
					back_depth_texture(		GL_TEXTURE_2D, GL_DEPTH_COMPONENT, GL_DEPTH_COMPONENT, GL_FLOAT)
	{
			...
			)
	{
		...
		back_fbo.bind();
		back_fbo.bindTexture(back_texture, 0, 0);
		back_fbo.bindTexture(back_normal_texture, 1, 0);
		back_fbo.bindDepthTexture(back_depth_texture, 0, 0);
		back_fbo.unbind();
		CGlErrorCheck();
	}
	...
	{
		CGlPeelingFrontBackFaces &c = *(CGlPeelingFrontBackFaces*)base_class;
