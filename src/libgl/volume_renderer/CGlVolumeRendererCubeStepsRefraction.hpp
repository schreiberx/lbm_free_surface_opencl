...
#ifndef CGL_VOLUME_RENDERER_CUBE_STEPS_REFRACTION_HPP
#define CGL_VOLUME_RENDERER_CUBE_STEPS_REFRACTION_HPP
...
/**
 * \brief OpenGL volume renderer using cube steps and refractions
 */
class CGlVolumeRendererCubeStepsRefraction	:
...
public:
	 ...
	 */
	CGlVolumeRendererCubeStepsRefraction()
	{
		cGlProgram.initVertFragShadersFromDirectory("volume_renderer/cube_steps_refraction");
