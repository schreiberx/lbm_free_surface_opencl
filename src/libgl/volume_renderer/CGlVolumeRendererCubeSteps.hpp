...
#ifndef CGL_VOLUME_RENDERER_CUBE_STEPS_HPP
#define CGL_VOLUME_RENDERER_CUBE_STEPS_HPP
...
/**
 * \brief OpenGL volume renderer using cube steps
 */
class CGlVolumeRendererCubeSteps	:
...
public:
	 ...
	 */
	CGlVolumeRendererCubeSteps()
	{
		cGlProgram.initVertFragShadersFromDirectory("volume_renderer/cube_steps");
		...
		)
	{
		...
		gradient_delta_uniform.set(gradient_delta);
