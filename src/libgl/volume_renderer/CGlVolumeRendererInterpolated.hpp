...
#ifndef CGL_VOLUME_RENDERER_INTERPOLATED_HPP
#define CGL_VOLUME_RENDERER_INTERPOLATED_HPP
...
/**
 * \brief OpenGL volume renderer using interpolation
 */
class CGlVolumeRendererInterpolated	:
...
public:
	 ...
	 */
	CGlVolumeRendererInterpolated()
	{
		cGlProgram.initVertFragShadersFromDirectory("volume_renderer/interpolated");
