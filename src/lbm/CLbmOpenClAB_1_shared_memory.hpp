...
#ifndef CLBM_OPENCL_AB_1_SHARED_MEMORY_OPEN_CL_HPP
#define CLBM_OPENCL_AB_1_SHARED_MEMORY_OPEN_CL_HPP
...
#define LBM_AB_TEST_WITH_AA_1_SHARED_MEMORY_KERNEL	0
 ...
 */
template <typename T>
class CLbmOpenClAB_1_shared_memory	:	
...
#if LBM_AB_TEST_WITH_AA_1_SHARED_MEMORY_KERNEL
...
public:
	 ...
	 */
	CLbmOpenClAB_1_shared_memory(	const CCLSkeleton &cClSkeleton,
...
#else
		CLBM_LOAD_PROGRAM(cProgram_Main,				cKernelLbm_Main_WorkGroupSize,				cKernelLbm_Main_MaxRegisters,				"data/cl_programs/lbm_ab_1_sm_coll_prop.cl");
